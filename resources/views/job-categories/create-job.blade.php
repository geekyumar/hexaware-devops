                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="department" style="width: 100%;" required>
                                ...
                                <!-- Options populated from Job Categories Management screen -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="job_location" style="width: 100%;" required>
                                <option disabled selected>Select a job location</option>
                                <!-- Options populated from Job Categories Management screen -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="employment_type" style="width: 100%;" required>
