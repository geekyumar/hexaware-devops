    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
        <form method="post" action="{{ url('/job-categories/edit') }}/{{ $category->id }}">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-5"> <!-- Equal size for both fields -->
                                ...
                                <input class="form-control" value="{{ $category->category_name }}" name="category_name" placeholder="Enter the category name" required>
                            </div>
