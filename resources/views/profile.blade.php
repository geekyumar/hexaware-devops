          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Name</label>
                  <input class="form-control" name="name" value="{{$profile->name}}" placeholder="Name" style="width: 100%;">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Role</label>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Skills</label>
                 <textarea class="form-control" name="skills" rows="2">{{$profile->skills}}</textarea>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <textarea class="form-control" name="education_details" rows="2">{{$profile->education_details}}</textarea>
                </div>
              </div>
              <!-- /.col -->
            </div>
