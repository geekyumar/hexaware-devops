...
<head>
  ...
  <title>Application Forms - Hexaware</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Application Form Management</b></h1>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Application Form Management</h3>
          </div>
          <!-- /.card-header -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="row">
                            ...
                            <table class="table table-hover text-nowrap">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{ $form->associated_jobs }}</td>
                                  <td>
                                    <div class="btn-group">
                                      <a href="{{ url('/application-forms/edit') }}/{{ $form->id }}" class="btn btn-warning btn-sm">Edit</a>
                                      <a href="{{ url('/application-forms/delete') }}/{{ $form->id }}" class="btn btn-danger btn-sm">Delete</a>
                                    </div>
                                  </td>
                                </tr>
                                @endforeach
                      ...
                      <!-- Create New Form Button - Centered Below the Table -->
                      <div class="form-group">
                        <div class="d-flex justify-content-center mt-4">
                          <a href="/application-forms/create" class="btn btn-primary btn-sm">
                            Create New Form
                          </a>
                        </div>
                      </div>
