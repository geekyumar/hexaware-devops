...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <body>
        @php $job = getJobDetails($application->job_id); @endphp
    
        <div class="row">
            <!-- Single Box for Applicant Information -->
            <div class="col-md-12">
        ...
        <div class="section-box mt-4">
            ...
            <div class="button-group">
                <a href="{{ url('/recruitment/updateStatus') }}/{{$application->id}}" class="btn btn-primary">Update Status</a>
