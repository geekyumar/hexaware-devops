  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Interview Scheduling Dashboard</b></h1>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="upcomingInterviews">Upcoming Interviews</label>
                      <input type="text" class="form-control" id="upcomingInterviews" name="upcoming_interviews" value="@php echo count($interviews) @endphp" readonly>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label class="pt-2">Interviews List Table</label>
                    <div class="card-body table-responsive p-0 pt-2">
                      <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            @php $applicant = getApplicantDetails($i->applicant_id) @endphp
                            @php $job = getJobDetails($i->job_id) @endphp
                          <!-- Example Row 1 -->
                          <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                <a href="{{ url('/interview/view') }}/{{ $i->id }}" class="btn btn-primary btn-sm">View</a>
                                <a href="{{ url('/interview/reschedule') }}/{{ $i->id }}" class="btn btn-primary btn-sm">Reschedule</a>
                                <a href="{{ url('/interview/cancel') }}/{{ $i->id }}" class="btn btn-primary btn-sm">Cancel</a>
                              </div>
                            </td>
                          </tr>
                          @endforeach
              ...
              <div class="form-group">
                <div class="row mt-3">
                  <div class="col-md-12 d-flex justify-content-center">
                    <!-- Updated button label only -->
                    <a href="/interview/schedule" class="btn btn-primary btn-sm">
