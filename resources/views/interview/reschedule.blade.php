  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Reschedule Interview</b></h1>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form method="post" action="{{ url('/interview/reschedule/') }}/{{$reschedule->id}}">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="interviewDatePicker">
                                <input type="date" class="form-control" id="interviewDate" value="{{ $reschedule->interview_date }}" name="interview_date" placeholder="Select new interview date" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="interviewTime" value="{{ $reschedule->interview_time }}" name="interview_time" required>
                            <div class="invalid-feedback">
                ...
                <div class="form-group">
                    <div class="row mt-3">
                        <div class="col-md-12 d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary btn-sm" id="rescheduleInterviewButton">
